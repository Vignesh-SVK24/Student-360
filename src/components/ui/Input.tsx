    ...
    <div className="w-full">
      ...
      <input
        ...
        className={cn(
          ...
          "focus:outline-none focus:ring-2 focus:ring-[#629176]/25 focus:border-[#0d4933] transition-all font-medium",
          className
        )}
        {...props}
      />
  ...
  return (
    <div className="w-full">
      ...
      <textarea
        ...
        className={cn(
          "block w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 placeholder-slate-400",
          "focus:outline-none focus:ring-2 focus:ring-[#629176]/25 focus:border-[#0d4933] transition-all font-medium resize-y min-h-[100px]",
          className
        )}
        {...props}
      />
