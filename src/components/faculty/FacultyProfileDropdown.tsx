      ...
      <div className="relative" ref={dropdownRef}>
        ...
        >
          <div className="relative">
            <img 
              ...
              alt="Faculty Avatar" 
              className="w-9 h-9 rounded-xl object-cover ring-2 ring-[#0d4933]/30 group-hover:ring-[#629176]/60 transition-all shadow-sm" 
            />
        ...
        <AnimatePresence>
          {dropdownOpen && (
            ...
            >
              {/* Faculty Info Card */}
              <div className="p-4 rounded-2xl bg-gradient-to-br from-[#0d4933]/15 via-[#629176]/10 to-slate-50 border border-[#629176]/30 mb-2">
                <div className="flex items-start gap-3">
                  <img 
                    src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150" 
                    alt="Dr. Sarah Jenkins" 
                    className="w-12 h-12 rounded-xl object-cover ring-2 ring-[#0d4933]/30 shadow-md"
                  />
                  <div className="flex-1 min-w-0">
                    ...
                    <span className="inline-block text-[10px] font-bold uppercase tracking-wider text-[#0d4933] bg-[#629176]/20 px-2 py-0.5 rounded-md mt-0.5">
                      Associate Professor
                    </span>
                  </div>
                </div>

                <div className="mt-3 pt-3 border-t border-[#629176]/25 space-y-1.5 text-xs text-slate-600">
              ...
              <div className="space-y-1 py-1 text-xs font-semibold">
                <button
                  ...
                  className="w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl text-slate-700 hover:text-[#0d4933] hover:bg-[#629176]/15 transition-all cursor-pointer group"
                >
                  <div className="flex items-center gap-2.5">
                    <Settings className="w-4 h-4 text-slate-400 group-hover:text-[#0d4933] transition-colors" />
                    <span>Faculty Settings</span>
                  </div>
                  <span className="text-[10px] font-bold text-slate-400 group-hover:text-[#629176]">Preferences</span>
                </button>
                ...
                <div className="flex items-center justify-between px-3.5 py-2 rounded-xl text-[11px] text-slate-500 bg-slate-50/60 border border-slate-100">
                  <div className="flex items-center gap-2">
                    <BookOpen className="w-3.5 h-3.5 text-[#629176]" />
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="flex items-center justify-between px-6 py-5 border-b border-slate-100 bg-slate-50/50">
                <div className="flex items-center gap-2.5">
                  <div className="w-8 h-8 rounded-xl bg-[#629176]/15 border border-[#629176]/30 flex items-center justify-center text-[#0d4933]">
              ...
              <form onSubmit={handleSaveSettings} className="p-6 space-y-5">
                ...
                <div className="p-3.5 rounded-2xl bg-[#629176]/10 border border-[#629176]/25 flex items-center justify-between text-xs">
                  <div>
                    <p className="font-bold text-[#0d4933]">Dr. Sarah Jenkins</p>
                    <p className="text-slate-500 text-[11px]">Faculty ID: FAC-CS-8924</p>
                  </div>
                  <span className="px-2.5 py-1 rounded-full text-[10px] font-bold bg-[#629176]/20 text-[#0d4933] border border-[#629176]/40">
                    Active Faculty
                  </span>
                </div>
                ...
                <div>
                  <div className="flex justify-between items-center mb-1.5">
                    ...
                    <span className="font-mono font-bold text-[#0d4933] text-xs bg-[#629176]/15 px-2 py-0.5 rounded-md border border-[#629176]/30">
                      {attendanceThreshold}%
                    </span>
                  </div>
                  <input
                    ...
                    className="w-full h-2 bg-slate-200 rounded-lg appearance-none cursor-pointer accent-[#0d4933]"
                  />
                ...
                <div className="space-y-3 pt-2 border-t border-slate-100">
                  <label className="flex items-center justify-between p-3 rounded-xl bg-slate-50/60 border border-slate-100 cursor-pointer hover:bg-slate-50 transition-colors">
                    <div className="flex items-center gap-2.5">
                      <BellRing className="w-4 h-4 text-[#0d4933]" />
                      <div>
                    ...
                    <input
                      ...
                      className="w-4 h-4 rounded text-[#0d4933] focus:ring-[#629176] accent-[#0d4933]"
                    />
                  </label>

                  <label className="flex items-center justify-between p-3 rounded-xl bg-slate-50/60 border border-slate-100 cursor-pointer hover:bg-slate-50 transition-colors">
                    <div className="flex items-center gap-2.5">
                      <BookOpen className="w-4 h-4 text-[#629176]" />
                      <div>
                ...
                <div className="pt-3 border-t border-slate-100 flex items-center justify-end gap-3">
                  ...
                  <button
                    type="submit"
                    className="px-5 py-2.5 rounded-xl text-xs font-bold text-white bg-gradient-to-r from-[#042821] via-[#0d4933] to-[#629176] hover:from-[#0d4933] hover:to-[#629176] shadow-md shadow-[#0d4933]/25 flex items-center gap-1.5 transition-all cursor-pointer"
                  >
                    {saveSuccess ? (
                      <>
